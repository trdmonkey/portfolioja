          ...
          {portfolioProjects.map((project) => (
            ...
            >
              ...
              <Image
                src={project.image}
                alt={project.title}
                className="mt-8 -mb-4 md:-mb-0 rounded-lg object-cover" /* -mb-4 para que la imagen salga completa y con padding-bottom */
              />{" "}
