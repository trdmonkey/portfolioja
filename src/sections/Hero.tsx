      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          ...
          <p className="mt-4 text-center text-white/60 md:text-lg">
            ...
            Exercitationem quae laboriosam magni sapiente suscipit ipsam
            consequuntur! Fugiat ab neque, commodi at quia quod inventore natus
            animi quis aliquam eum nulla!
          </p>
        </div>
