  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "float-random-3": {
          "0%, 100%": { transform: "translate(0px, 0px) rotate(0deg)" },
          "20%": { transform: "translate(-30px, -30px) lg:translate(-60px, -40px)" },
          "40%": { transform: "translate(40px, 20px) lg:translate(50px, -20px)" },
          "60%": { transform: "translate(-25px, 55px) lg:translate(-30px, 40px)" },
          "80%": { transform: "translate(35px, -25px) lg:translate(40px, 30px)" },
        },
      },
    },
  },
